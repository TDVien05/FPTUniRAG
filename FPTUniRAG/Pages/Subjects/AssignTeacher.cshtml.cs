...
public class AssignTeacherModel : PageModel
{
    ...
    public AssignTeacherModel(ISubjectManagementService subjectManagementService)
    {
    ...
    public IReadOnlyList<SubjectTeacherAssignmentListItemDto> Subjects { get; private set; } = [];
    ...
    public async Task<IActionResult> OnPostAsync(CancellationToken cancellationToken)
    {
        ...
        var result = await _subjectManagementService.AssignTeacherAsync(
            SubjectId,
            TeacherId,
            cancellationToken);
    ...
    {
        Subjects = await _subjectManagementService.GetSubjectsForTeacherAssignmentAsync(cancellationToken);
