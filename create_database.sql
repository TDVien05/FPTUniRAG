...
VALUES
    (
        'basic',
        'Basic',
        'Default student plan with standard chat quota.',
        0,
        20000,
        100000,
        400000,
    ...
    (
        'plus',
        'Plus',
        'Paid student plan with expanded features and no hard chat quota.',
        99000,
        NULL,
        NULL,
        NULL,
    ...
    (
        'pro',
        'Pro',
        'Higher-tier student plan with advanced models and no hard chat quota.',
        199000,
        NULL,
        NULL,
        NULL,
    ...
    (
        'vip',
        'VIP',
        'Top-tier student plan with unlimited chat access and premium support.',
        399000,
        NULL,
        NULL,
        NULL,
