...
public sealed class MomoPaymentService : IMomoPaymentService
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        await _paymentRepository.AddMomoTransactionAsync(transaction, cancellationToken);
        ...
        if (!response.IsSuccessStatusCode)
        {
            ...
            await _paymentRepository.SaveMomoTransactionAsync(transaction, cancellationToken);
        ...
        CancellationToken cancellationToken)
    {
        ...
        var transaction = await _paymentRepository.FindMomoTransactionAsync(orderId, requestId, cancellationToken);
        ...
        var now = DateTime.UtcNow;
        await _paymentRepository.ActivateMomoSubscriptionAsync(transaction, now, cancellationToken);
